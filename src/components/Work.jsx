        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="bg-nes-light border-2 border-nes-dark hover:border-nes-orange transition-all duration-300">
            ...
            <div className="p-4 sm:p-6">
              <h3 className="text-base sm:text-lg font-bold text-nes-dark mb-2 sm:mb-3 text-center uppercase tracking-wide">
                Data-Centric Industrial Predictive Maintenance (Systematic Literature Review)
              </h3>
              <p className="text-xs sm:text-sm text-nes-dark text-center mb-3 sm:mb-4">
              ...
              <div className="flex flex-wrap justify-center gap-2">
                <a href={PredictiveMaintenancePaper} target="_blank" rel="noopener noreferrer">
                  <button className="bg-nes-white text-nes-dark border-2 border-nes-dark px-3 py-2 sm:px-4 hover:bg-nes-orange hover:text-nes-white hover:border-nes-orange transition-all duration-300 font-medium uppercase text-xs sm:text-sm">
                    Report
                  </button>
                </a>
