    ...
    <div>
      ...
      <div className="z-10 fixed w-full h-[60px] sm:h-[70px] flex justify-between items-center px-4 sm:px-8 bg-nes-dark text-nes-white border-b-2 border-nes-light">
        ...
        <ul className="hidden md:flex gap-4 lg:gap-8 text-xs lg:text-sm font-medium uppercase tracking-wide">
          <li>
            <Link to="hero" smooth={true} duration={50} className="block px-3 py-2 border border-transparent hover:border-nes-orange hover:bg-nes-orange hover:text-nes-white duration-200 transition-all cursor-pointer">
              Home
            </Link>
          </li>
          <li>
            <Link to="about" smooth={true} duration={50} className="block px-3 py-2 border border-transparent hover:border-nes-orange hover:bg-nes-orange hover:text-nes-white duration-200 transition-all cursor-pointer">
              About
            </Link>
          </li>
          <li>
            <Link to="skills" smooth={true} duration={50} className="block px-3 py-2 border border-transparent hover:border-nes-orange hover:bg-nes-orange hover:text-nes-white duration-200 transition-all cursor-pointer">
              Skills
            </Link>
          </li>
          <li>
            <Link to="work" smooth={true} duration={50} className="block px-3 py-2 border border-transparent hover:border-nes-orange hover:bg-nes-orange hover:text-nes-white duration-200 transition-all cursor-pointer">
              Work
            </Link>
          </li>
          <li>
            <Link to="contact" smooth={true} duration={50} className="block px-3 py-2 border border-transparent hover:border-nes-orange hover:bg-nes-orange hover:text-nes-white duration-200 transition-all cursor-pointer">
              Contact
            </Link>
          </li>
        </ul>
        ...
        >
          <li className="border-b border-nes-light w-full">
            <Link onClick={handleClick} to="hero" smooth={true} duration={50} className="block py-5 px-6 text-xl sm:text-2xl text-nes-white uppercase tracking-wide hover:text-nes-orange transition-colors cursor-pointer text-center">
              Home
            </Link>
          </li>
          <li className="border-b border-nes-light w-full">
            <Link onClick={handleClick} to="about" smooth={true} duration={50} className="block py-5 px-6 text-xl sm:text-2xl text-nes-white uppercase tracking-wide hover:text-nes-orange transition-colors cursor-pointer text-center">
              About
            </Link>
          </li>
          <li className="border-b border-nes-light w-full">
            <Link onClick={handleClick} to="skills" smooth={true} duration={50} className="block py-5 px-6 text-xl sm:text-2xl text-nes-white uppercase tracking-wide hover:text-nes-orange transition-colors cursor-pointer text-center">
              Skills
            </Link>
          </li>
          <li className="border-b border-nes-light w-full">
            <Link onClick={handleClick} to="work" smooth={true} duration={50} className="block py-5 px-6 text-xl sm:text-2xl text-nes-white uppercase tracking-wide hover:text-nes-orange transition-colors cursor-pointer text-center">
              Work
            </Link>
          </li>
          <li className="w-full">
            <Link onClick={handleClick} to="contact" smooth={true} duration={50} className="block py-5 px-6 text-xl sm:text-2xl text-nes-white uppercase tracking-wide hover:text-nes-orange transition-colors cursor-pointer text-center">
              Contact
            </Link>
          </li>
        </ul>
